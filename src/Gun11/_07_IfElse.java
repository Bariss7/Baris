...
public class _07_IfElse {
    public static void main(String[] args) {
        ...
        sifre.contains("pass");
        //sifre.contains8"pas")//içinde sifre kelimesi var mı sonucu geçiyorsa true geçmiyorsa false
        //sifre.contains("pass) == false ile !sifre.contains("pass") geçiyor değilse
